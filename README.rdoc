...
* <b>-e JWT_SECRET= [JWT_SECRET]:</b> Setting the JWT_SECRET variable is necessary for signing tokens to be validated by the IGV BAM file server.  If this is not set correctly, users cannot view BAM files in IGV.
* <b>-e IGV_URL= [IGV_URL]:</b> The URL for the IGV BAM file server.  Contact {Andrew Zimmer}[mailto:andrew@broadinstitute.org] for more information about this service.
